...
const ElasticSlider: React.FC<ElasticSliderProps> = ({
  ...
  return (
    // Increased width to w-64 for better spacing with text icons
    <div
    ...
    >
      <Slider
        ...
        leftIcon={leftIcon}
        rightIcon={rightIcon}
        onChange={onChange} // Pass onChange down
      />
    </div>
  );
};
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            {/* Use theme colors: bg-muted for track, bg-primary for fill */}
      ...
      {/* Use theme color: text-muted-foreground for value display */}
      {/* Adjusted position slightly with translate-y-[-18px] */}
      <p className="absolute text-muted-foreground transform translate-y-[-18px] text-xs font-medium tracking-wide">
        {Math.round(value)}
      </p>
    </>
  );
